...
public class ScnRemainingEstimateCFType extends AbstractScnTimeCFType {
    ...
    protected Long getTime(IScnExtendedIssue extIssue) {
        return extIssue != null ? extIssue.getEstimate() : null;
    }
}
