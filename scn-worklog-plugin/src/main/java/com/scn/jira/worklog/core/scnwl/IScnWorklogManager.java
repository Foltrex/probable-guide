...
{
  boolean delete(ApplicationUser paramUser, IScnWorklog paramWorklog, Long paramLong, Long newLinkedEstimate, boolean paramBoolean, boolean isLinkedWL) throws DataAccessException;

  IScnWorklog update(ApplicationUser paramUser, IScnWorklog paramWorklog, Long paramLong, Long newLinkedEstimate, boolean paramBoolean, boolean isLinkedWL) throws DataAccessException;

  IScnWorklog create(ApplicationUser paramUser, IScnWorklog paramWorklog, Long paramLong, Long newLinkedEstimate, boolean paramBoolean, boolean isLinkedWL) throws DataAccessException;
