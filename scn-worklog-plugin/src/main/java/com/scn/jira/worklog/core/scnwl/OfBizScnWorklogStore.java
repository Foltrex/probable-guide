...
{
	//private static final org.apache.log4j.Logger LOGGER = org.apache.log4j.Logger.getLogger(OfBizScnWorklogStore.class);
	...
	{
		List<IScnWorklog> worklogs = new ArrayList<IScnWorklog>();
