...
public class ScnWorklogImpl implements IScnWorklog {
	...
	//private static final org.apache.log4j.Logger LOG = org.apache.log4j.Logger.getLogger(ScnWorklogImpl.class);
    ...
    public ScnWorklogImpl(ProjectRoleManager projectRoleManager, Issue issue, Long id, String authorKey,
                          String comment, Date startDate, String groupLevel, Long roleLevelId,
                          Long timeSpent, String worklogTypeId) {
        if (timeSpent == null) {
    ...
    public ScnWorklogImpl(ProjectRoleManager projectRoleManager, Issue issue, Long id, String authorKey,
                          String comment, Date startDate, String groupLevel, Long roleLevelId,
                          Long timeSpent, String updateAuthorKey, Date created, Date updated, String worklogTypeId) {
        if (timeSpent == null) {
            throw new IllegalArgumentException("timeSpent must be set!");
        }
        this.projectRoleManager = projectRoleManager;
    ...
    public ProjectRole getRoleLevel() {
    	return (this.roleLevelId == null) ? null : projectRoleManager.
    			getProjectRole(this.roleLevelId);
    }
...
//        if (username != null) {
//            fullName = ApplicationUsers.byKey(username).getDisplayName();
//        }
//        return fullName;
