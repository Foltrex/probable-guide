...
public class OfBizScnExtendedIssueStore implements IScnExtendedIssueStore {
    ...
    public IScnExtendedIssue getByIssue(Issue issue) throws DataAccessException {
        ...
        final List<GenericValue> list = ofBizDelegator.findByAnd(ENTITY_EXTENDED_ISSUE, MapBuilder.build("issue", issue.getId()));
    ...
    protected IScnExtendedIssue convertToScnExtendedIssue(Issue issue, GenericValue gv) {
        ...
        IScnExtendedIssue extIssue = new ScnExtendedIssue(issue, gv.getLong("id"), gv.getLong("timeoriginalestimate"), gv.getLong("timeestimate"), gv.getLong("timespent"));
        return extIssue;
    }
