...
public class JiraScnRestServiceUtil {
	...
	public static final String GROUP_LEVEL_ATTR_NAME = "groupLevel";
	public static final String ROLE_LEVEL_ID_ATTR_NAME = "roleLevelId";
	public static final String START_DATE_ATTR_NAME = "startDate";
	public static final String TIME_SPENT_ATTR_NAME = "timeSpent";
	public static final String TIME_SPENT_SEC_ATTR_NAME = "timeSpentInSeconds";
	public static final String AUTHOR_ATTR_NAME = "author";
	public static final String UPDATE_AUTHOR_ATTR_NAME = "updateAuthor";
