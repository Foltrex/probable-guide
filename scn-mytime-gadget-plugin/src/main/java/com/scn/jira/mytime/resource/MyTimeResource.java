...
public class MyTimeResource {
	...
	@Inject
	public MyTimeResource(@ComponentImport IssueManager issueManager,
			@ComponentImport ProjectRoleManager projectRoleManager,
			@Qualifier("overridedWorklogManager") WorklogManager overridedWorklogManager,
			@ComponentImport JiraAuthenticationContext jiraAuthenticationContext) {
		this.authenticationContext = jiraAuthenticationContext;
		this.myTimeManager = new MyTimeManager(issueManager, projectRoleManager, overridedWorklogManager,
