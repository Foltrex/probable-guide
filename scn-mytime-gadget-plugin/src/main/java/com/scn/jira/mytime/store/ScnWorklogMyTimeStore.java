...
public class ScnWorklogMyTimeStore {
	...
	public ScnWorklogMyTimeStore(IssueManager issueManager, ProjectRoleManager projectRoleManager,
	...
	public List<IScnWorklog> getScnWorklogsByUserBetweenDates(Date startDate, Date endDate, String user)
